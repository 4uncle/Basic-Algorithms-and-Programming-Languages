...
<!-- TOC -->autoauto- [Python入门学习](#python入门学习)auto            - [1.python在sublime 中执行](#1python在sublime-中执行)auto            - [2.在打印字符串时一定要加上单引号或者双引号，单引号换行不会保留格式，三引号才会保留格式](#2在打印字符串时一定要加上单引号或者双引号单引号换行不会保留格式三引号才会保留格式)auto            - [3.python中的字符串拼接的几种方式](#3python中的字符串拼接的几种方式)auto            - [4.python类型检测](#4python类型检测)auto            - [5.对象就是存储数据结构的一个容器，OOP编程中一切皆对象](#5对象就是存储数据结构的一个容器oop编程中一切皆对象)auto            - [6.关于对象的内存解释](#6关于对象的内存解释)auto            - [7.算术运算](#7算术运算)auto            - [8.赋值运算](#8赋值运算)auto            - [9.关系运算](#9关系运算)auto            - [10.逻辑运算](#10逻辑运算)auto            - [11.条件运算](#11条件运算)auto            - [12.关于代码块的缩进](#12关于代码块的缩进)auto            - [13.while循环使用方法](#13while循环使用方法)auto            - [14.在print中如果加入end=‘’，则输入不会换行](#14在print中如果加入end则输入不会换行)auto            - [15.关于切片概念](#15关于切片概念)auto            - [16.list的通用操作](#16list的通用操作)auto            - [17.for循环使用](#17for循环使用)auto            - [18.range的作用](#18range的作用)auto            - [19.关于 ==          !=         is            is not](#19关于--------------------is------------is-not)auto            - [20.关于python中的字典](#20关于python中的字典)auto            - [21.关于集合的用法](#21关于集合的用法)auto            - [22.元组及其解包运算](#22元组及其解包运算)auto            - [23.python中输入](#23python中输入)auto            - [24.函数的具体操作](#24函数的具体操作)auto            - [25.关于不定长参数传递](#25关于不定长参数传递)auto            - [26.关于函数和函数对象的区别](#26关于函数和函数对象的区别)auto            - [27.python中使用global对全局变量赋值](#27python中使用global对全局变量赋值)auto            - [28.高阶函数操作以及lambda函数](#28高阶函数操作以及lambda函数)auto            - [29.关于python的闭包处理](#29关于python的闭包处理)auto            - [30.python中类的初始化以及操作](#30python中类的初始化以及操作)auto            - [31.封装](#31封装)auto            - [31.2.使用装饰器](#312使用装饰器)auto            - [32.继承](#32继承)auto            - [33.多重继承](#33多重继承)auto            - [34.多态](#34多态)auto            - [35.类中方法](#35类中方法)auto            - [36.垃圾回收](#36垃圾回收)auto            - [37.模块的使用](#37模块的使用)auto            - [38.异常处理](#38异常处理)auto            - [39.文件操作](#39文件操作)auto            - [40.文件写入操作](#40文件写入操作)auto            - [41.文件读取模式](#41文件读取模式)auto            - [42.文件读取位置](#42文件读取位置)auto            - [43.python编写时注意指定文件编码格式](#43python编写时注意指定文件编码格式)autoauto<!-- /TOC -->
